...
Implemented in `crates/lsp/src/diagnostics.rs`.

- Source: parser errors only.
- Severity: `ERROR`.
- Diagnostic source string: `eye-parser`.
...
- Lexer diagnostics.
- HIR/name/type diagnostics.
- Related information, tags, codes, or code descriptions.
