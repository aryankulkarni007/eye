...
Status: PLAN. Nothing in this document is built yet. It records the target
architecture and the invariants the refactor must hold. `DESIGN.md` holds the
long-term language vision; this file is the concrete pipeline plan grounded in
the current code.
