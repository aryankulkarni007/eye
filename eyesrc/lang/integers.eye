-- integers and casts: the sized signed/unsigned primitives and `as` casts
-- (truncation, int->float promotion, tight binding in a widening add, and a
-- widen/narrow roundtrip).
