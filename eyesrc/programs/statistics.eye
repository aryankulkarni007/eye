...
main() {
    ...
    println("data:     {} {} {} {} {} {}", xs[0], xs[1], xs[2], xs[3], xs[4], xs[5]);
    println("count:    {}", n);
    println("sum:      {}", sum(ptr, n));
    println("mean:     {}", mean(ptr, n));
    println("min:      {}", min_value(ptr, n));
    println("max:      {}", max_value(ptr, n));
    println("variance: {}", variance(ptr, n));
    println("stddev:   {}", stddev(ptr, n));
}
